...
@Component({
  ...
  animations: [fade, fadeF, fadeB, fadeFbtn, fadeBbtn],
})
export class AppComponent {
  ...
  constructor(private scroller: ViewportScroller) {} // private _router: Router // private _route: ActivatedRoute,
  ...
  ngOnInit() {
    ...
    $(document).ready(() => {
      $(".next").click(function () {
        ...
        if ($target.length == 0) $target = $(".project:first");
        $("html, body").animate(
          {
  ...
  showFront(): void {
    this.show = !this.show;
	let anchor = "top" + (this.show ? "_front" : "_back");
	console.log(anchor);
